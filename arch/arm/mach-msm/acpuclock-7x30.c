...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
	...
	{ 0, 245760, PLL_3,    5, 2,  61440000,  850, VDD_RAW(850) },
	 ...
	 * AXI has MSMC1 implications. See above.
	 */
	{ 1, 806400,  PLL_2, 3, 0, UINT_MAX, 975, VDD_RAW(975), &pll2_tbl[3]},
	{ 1, 1024000, PLL_2, 3, 0, UINT_MAX, 1075, VDD_RAW(1075), &pll2_tbl[4]},
	{ 1, 1200000, PLL_2, 3, 0, UINT_MAX, 1175, VDD_RAW(1175), &pll2_tbl[5]},
